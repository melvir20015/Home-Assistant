...
- [`ac-produccion-manual-auto.md`](./ac-produccion-manual-auto.md): contrato operativo en producción, incluyendo la reconciliación runtime/UI del helper `input_select.ac_ultimo_modo_no_fan`, la erradicación obligatoria del valor legacy inválido `False` y la revalidación posterior del ciclo `COOL`.
